      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-black-800"> MI LISTA DE USUARIOS FTP</h1>
          ...
          <div class="row">
            <div class="col-lg-12 mx-auto">
              <div class="page-header clearfix">
                <a href="ftp_add.php" class="btn btn-success pull-right">Añadir Nuevo Usuario FTP</a>
              </div>

              <?php
              $resultado = mysqli_query($conexiondocker, "SELECT * FROM tblftpusuarios u
                                                          INNER JOIN tblhosts h
                                                          ON u.idhost = h.idHost   ");
              ...
              ?>
                <table class='table table-hover '>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $row["idUsuarioFtp"]; ?></td>
                        <td><?php echo $row["strUsuario"]; ?></td>
                        <td><?php echo $row["strUsuarioftp"]; ?></td>
                        <td><?php echo $row["srtDominio"]; ?></td>
                        <td><?php echo $row["dtmFechaReg"]; ?></td>
                        <td>
                          <a href="ftp_delete.php?idUsuarioFtp=<?php echo $row["idUsuarioFtp"]; ?>&idHost=<?php echo $row["idHost"];?>"
                          title='Eliminar FTP' class="material-icons" onclick="return Confirmation()"><span class="glyphicon glyphicon-remove"></span></a>
                        </td>
                      </tr>
                    <?php
                      $i++;
